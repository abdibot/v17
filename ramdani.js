...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© BY VANZZ OFC","listType": "SINGLE_SELECT","sections": list}}, {})
...
"externalAdReply": {
                ...
                "body": `${faketroli}`,
                "mediaType": "10",
                "mediaUrl": `https://m.youtube.com/channel/UCEDb6SkiPU0theI8J_WEZZA`,
                "thumbnailUrl": "https://m.youtube.com/channel/UCEDb6SkiPU0theI8J_WEZZA",
                "thumbnail": fakeimg,
                "sourceUrl": `https://m.youtube.com/channel/UCEDb6SkiPU0theI8J_WEZZA`,
      ...
      const demoteAdmin = async function(to, target=[]){
          ...
          if (!packname) packname = 'Dibuat Oleh'; if (!author) author = '© VANZZ OFC';author = author.replace(/[^a-zA-Z0-9]/g, '');	
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/foto/thumb.jpg`)},"title": `© BY VANZZ OFC`,"description": "VANZZ OFC", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "VANZZ OFC","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif Selama ${(danzrun)} © Creator By VANZZ OFC`).catch((_)=>_); //DI UBAH YATIMM
...
`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'sɪᴍᴘᴇʟ ᴍᴇɴᴜ'},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: 'ʀᴜʟᴇs'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'ᴊɪᴋᴀ ᴛᴏᴍʙᴏʟ ᴅɪ ʙᴀᴡᴀʜ ᴇʀʀᴏʀ sɪʟᴀʜᴋᴀɴ ᴋᴇʟɪᴋ .command ᴜɴᴛᴜᴋ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ\n© BY VANZZ OFC', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
> 532 ${prefix}nsfw_avatar`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: '© BY VANZZ OFC', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
❏ GITHUB CREATOR : https://github.com/abdibot
❏ YT CREATOR : https://m.youtube.com/channel/UCEDb6SkiPU0theI8J_WEZZA
*━━━━━━━━━━━━━━━━━━━━*`)
randommusic = fs.readFileSync(`./media/audio/${randomaudio}.mp3`)
Ramdani.sendMessage(from, randommusic, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
...
if (isBanned) return freply(mess.banned)
freply(`━━━━━ *SCRIPT* ━━━━━
❏ LINK VIA GITHUB : https://github.com/abdibot
❏ BASE ORI : VANZZ OFC
❏ TYPE SC : nodejs
❏ DI BUAT PADA : sel, 29, mart, 2022
*━━━━━━━━━━━━━━━━━━━━*`)
...
case 'tiktok':
              ...
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt VANZZ OFC\n Help 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan':
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI VANZZ OFC\`\`\`')
...
case 'ttp':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
              if (args.length == 0) return freply(`Example: ${prefix + command} VANZZ OFC`)
              woy = args.join(" ")
              freply(mess.wait)
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© BY VANZZ OFC* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
              if (!isRegist) return freply(mess.regist)
              if (isDewasa) return freply(mess.dewasa)
...
Ramdani.sendMessage(from, tapib1, document, { quoted: mek, filename:`VANZZ OFC ~ 404 ${danz}.mp3`, mimetype: 'audio/application' })
...
"caption": "https://chat.whatsapp.com/KazGpGgVJv1K9TkpzrZoFL",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
